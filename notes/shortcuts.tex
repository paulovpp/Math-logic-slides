...
% Set background color of the frame - insert immediately outside the frame 
{
...
% Set a background picture - insert inside a block environment
\usepackage{tikz}
...
% Several columns with an enumerate environment\setbeamercovered{invisible}
